...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to cmkd "gobject list" output
    ...
    def cmkd_serialise(self):
        import cmklib
        return cmklib.SHIM_serialise_for_cmkd(self.serialise())
